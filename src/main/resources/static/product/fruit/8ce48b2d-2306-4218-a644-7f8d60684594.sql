...
-- 테이블 데이터 bookorder.book:~3 rows (대략적) 내보내기
DELETE FROM `book`;
...
-- 테이블 데이터 jboard.file:~3 rows (대략적) 내보내기
DELETE FROM `file`;
...
-- 테이블 데이터 market_db.hongong1:~3 rows (대략적) 내보내기
...
-- 테이블 데이터 market_db.hongong2:~4 rows (대략적) 내보내기
...
-- 테이블 데이터 market_db.hongong3:~3 rows (대략적) 내보내기
...
-- 테이블 데이터 shop.order:~11 rows (대략적) 내보내기
DELETE FROM `order`;
INSERT INTO `order` (`orderNo`, `orderId`, `orderProduct`, `orderCount`, `orderDate`) VALUES
...
-- 테이블 데이터 studydb.user:~3 rows (대략적) 내보내기
DELETE FROM `user`;
...
-- 테이블 데이터 studydb.user1:~5 rows (대략적) 내보내기
DELETE FROM `user1`;
...
-- 테이블 데이터 world.city:~4,079 rows (대략적) 내보내기
DELETE FROM `city`;
